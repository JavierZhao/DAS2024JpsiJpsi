...
void null_BW3(){
  ...
  double numTh3Init = 1.27056e+03, numTh3Min = 0, numTh3Max = 10000;
  ...
  numTh3.setConstant(kFALSE);
    ...
    double numTh4Init = 1.27056e+03, numTh4Min = 0, numTh4Max = 10000;
  ...
  // BW0
  double massTh1Init = 6.3000e+00, massTh1Min = 6.20, massTh1Max = 6.50;
  ...
  // BW1
  double massTh2Init = 6.5e+00, massTh2Min = 6.4, massTh2Max = 6.6;
  RooRealVar massTh2("massTh2", "massTh2", massTh2Init, massTh2Min, massTh2Max);
  massTh2.setConstant(kFALSE); //m_0
  double widthTh2Init = 3.53406e-01, widthTh2Min = 0.00, widthTh2Max = 1.50;
  ...
  // now add the final resonance BW3
  ...
  RooFFTConvPdf Th2Reso("Th2Reso", "Th2Reso",
    ...
    MyRelBWSquare Th3("Th3", "Th3", mx,
        massTh3, widthTh3, LTh3, dTh3, coefTh3, phiTh3);
    // We also need to take into account detector smearing which affect the resolution of the peak
  ...
  MyRelBWSquare Th4("Th4", "Th4", mx,
      massTh4, widthTh4, LTh4, dTh4, coefTh4, phiTh4);
  // We also need to take into account detector smearing which affect the resolution of the peak
  ...
  */
  ...
  model.plotOn(frame, Components(dpsPdf), Name("Dps"), LineColor(kGreen+1), LineStyle(1));
  ...
  model.plotOn(frame, Components(Th3Reso), Name("Th3"), LineColor(kRed), LineStyle(kDashDotted));
  model.plotOn(frame, Components(Th4Reso), Name("Th4"), LineColor(kOrange), LineStyle(kDashDotted));
  ...
  pullFrame->Draw();
  c1.Update();
  c1.SaveAs("figure/fit_all_peaks.png");
